...
const AboutMe = ({HandleToolTip}) => {
  ...
  return (
    <div className="main-container w-full rounded-md shadow-2xl  text-white bg-white flex justify-center items-center max-w-[80%]  mx-auto z-40 relative">
      <div className="  bg-[#191919] shadow-lg h-full px-4 sm:px-20 pt-4 grid grid-cols-1 md:grid-cols-2 justify-center items-center">
      <button className="absolute top-4 right-5 sm:right-8" onClick={HandleToolTip}>
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg>
        ...
        <div className="detals px-4 sm:px-8">
          <h1 className="text-[#1788ae] text-xl font-extrabold py-2">
            ABOUT ME
          </h1>

          <p className="py-4">
            Hello! I'm Akash, a passionate full-stack developer with expertise
            in the MERN stack (MongoDB, Express.js, React, Node.js). I love
            building robust, scalable web applications and have a keen interest
            in creating user-friendly experiences. I’ve worked on a range of
            projects
          </p>

          <div className="techStack py-2">
            <ul className=" flex flex-wrap gap-2 text-slate-200">
              {techList?.map((item, index) => {
                return (
                  <li className="border px-2 rounded-full" key={index}>
                    {item}
                  </li>
                );
              })}
          ...
          <div className="top-skill">
            <h1 className="text-[#1788ae] text-xl font-extrabold py-12 sm:pb-20">
              MERN STACK
            </h1>

            <div className="top-skills-icons mb-4 flex items-center">
              <div className="mongodb-icon flex flex-col items-center w-20 group relative">
                <div className="tooltip shadow-xl invisible group-hover:visible  ease-in-out duration-400">
                  <p className=" border-none bg-[#47a248] text-white text-xl z-40 font-bold border px-2 absolute -top-10 -left-4 rounded-full ">
                    mongoDb
                  </p>
                  <div className="w-2 h-2 bg-[#47a248] text-white relative -top-4 z-0 rotate-45"></div>
                </div>
                <svg
                ...
                <h2 className="text-[#47a248] text-xl font-bold">M</h2>
              </div>
              <div className="express-icon flex flex-col items-center w-20 relative group">
                <div className="tooltip shadow-xl invisible group-hover:visible  ease-in-out duration-400">
                  <p className=" border-none bg-[#fff] text-black text-xl z-40 font-bold border px-2 absolute -top-10 -left-4 rounded-full ">
                    Express.JS
                  </p>
                  <div className="w-2 h-2 bg-[#ffff] relative -top-4 z-0 rotate-45"></div>
                </div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 32 32"
                ...
                <h2 className="text-[#ffffff] text-xl font-bold">E</h2>
              </div>
              <div className="react-icon flex flex-col items-center w-20 relative group">
                <div className="tooltip shadow-xl invisible group-hover:visible  ease-in-out duration-400">
                  <p className=" border-none bg-[#61dafb] text-black text-xl z-40 font-bold border px-2 absolute -top-10 -left-4 rounded-full ">
                    React.JS
                  </p>
                  <div className="w-2 h-2 bg-[#61dafb] relative -top-4 z-0 rotate-45"></div>
                </div>
                <svg
                  width="50"
                  height="50"
                ...
                <h2 className="text-[#61dafb] text-xl font-bold">R</h2>
              </div>
              <div className="node-icon flex flex-col items-center w-20 relative group">
                <div className="tooltip shadow-xl invisible group-hover:visible  ease-in-out duration-400">
                  <p className=" border-none bg-[#8cc84b] text-white text-xl z-40 font-bold border px-2 absolute -top-10 -left-4 rounded-full ">
                    React.JS
                  </p>
                  <div className="w-2 h-2 bg-[#8cc84b] relative -top-4 z-0 rotate-45"></div>
                </div>
                <svg
                  width="50"
                  height="50"
                ...
                <h2 className="text-[#8cc84b] text-xl font-bold">N</h2>
              </div>
            </div>
          </div>
        </div>

        <div className="testimonial w-full h-full hidden sm:block">
          <svg
