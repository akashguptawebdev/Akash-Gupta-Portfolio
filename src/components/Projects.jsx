...
// import {assetImage} from "../assets/ExportImages"
const Projects = () => {
  ...
  return (
    <>
      <section
        id="next-section"
        className={`max-w-screen-xl mx-auto px-4 relative pb-8 sm:pb-16 mt-12 ${state?"text-black bg-white":"text-white bg-black"} `}
      >
        <h2 className={`text-3xl sm:text-[40px] ${state?"text-[#1788ae] bg-white":"text-[#1788ae] bg-[#111]"} relative z-10 font-bold px-4 py-2 w-max mx-auto text-center  sm:border-b-2 border-[#1788ae]`}>
          Latest Works
        </h2>
        <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
          ...
          <div className="w-4 h-4 rounded-full border-[3px] border-[#459bd5] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block" />
          <a
            href="https://task-basket.vercel.app/"
            target="_blank"
          ...
          <div className="w-full">
            ...
            <p className="text-justify text-sm md:text-base mt-2">
              Organize your tasks efficiently with Task Basket. Track progress,
              manage deadlines, and stay productive. Enjoy a seamless experience
              with secure user authentication, allowing you to log in safely and
              access your personalized task list from anywhere. Stay on top of
              your daily goals effortlessly!
            </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
          <div className="order-2 sm:order-1 w-full">
            ...
            <p className="text-justify text-sm md:text-base mt-2">
              Kanban Flow is a dynamic Kanban board application designed to
              streamline task management through a visually interactive
              interface. Ideal for both individuals and teams, this application
              enhances productivity by enabling users to manage tasks across
          ...
          <div className="h-[1px] left-1/2 right-1/4 bg-[#1788ae] absolute top-1/2 hidden sm:block" />
          <div className="w-4 h-4 rounded-full border-[3px] border-[#ffe578] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block" />
          <a
            href="https://kanban-flows.vercel.app/"
            target="_blank"
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
          <div className="h-[1px] left-1/4 right-1/2 bg-[#1788ae] absolute top-1/2 hidden sm:block" />
          <div className="w-4 h-4 rounded-full border-[3px] border-[#fc815c] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block" />
          <a
            href="https://shopy-glob.vercel.app/"
            target="_blank"
            className="flex w-full relative justify-center sm:justify-start"
          >
          ...
          <div className="w-full">
            ...
            <p className="text-justify text-sm md:text-base mt-2">
              Explore a world of products at Shoppy Glob! Enjoy a seamless
              shopping experience with an intuitive interface, secure user
              authentication, and easy-to-navigate features. Shop with
              confidence and convenience, all in one place.
            </p>
            <ul className="flex flex-wrap gap-2 mt-2">
              <li className="border rounded-[50px] border-[#999] px-[10px] py-[5px] text-sm md:text-base">
                #react.js
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
          <div className="order-2 sm:order-1 w-full">
            ...
            <p className="text-justify text-sm md:text-base mt-2">
              Mausam Channel provides real-time weather updates with accurate
              forecasts and a user-friendly interface. Stay informed about
              current weather conditions, upcoming forecasts, and severe weather
              alerts, all in one place. Designed for easy navigation and quick
              access to vital weather information, Mausam Channel ensures you're
              always prepared for what's ahead, whether it's a sunny day or a
              stormy night. Stay ahead of the weather with reliable and
              up-to-date insights.
            </p>
            <ul className="flex flex-wrap gap-2 mt-2">
              <li className="border rounded-[50px] border-[#999] px-[10px] py-[5px] text-sm md:text-base">
          ...
          <div className="h-[1px] left-1/2 right-1/4 bg-[#1788ae] absolute top-1/2 hidden sm:block" />
          <div className="w-4 h-4 rounded-full border-[3px] border-[#47afa1] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block" />
          <a
            href="https://mausamchannel.netlify.app/"
            target="_blank"
            className="order-1 sm:order-2 flex w-full relative justify-center sm:justify-start"
          >
            <div className="flex flex-col items-center relative group sm:hover:scale-105 ease-in-out duration-200 sm:ml-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
          ...
          <div className="w-4 h-4 rounded-full border-[3px] border-[#fc815c] absolute left-1/2 -translate-x-1/2 bg-[#111] z-10 hover:scale-110 ease-in-out duration-100 hidden sm:block" />
          <a
            href="https://book-vault-six.vercel.app/"
            className="flex w-full relative justify-center sm:justify-start"
          >
            <div className="flex flex-col items-center relative group hover:scale-105 ease-in-out sm:mr-auto duration-200">
              <img
                className="max-w-[400px] w-full mr-auto relative z-10 drop-shadow-[0_0px_60px_rgba(59,130,246,0.6)]"
                src="/BookVaultLaptop.png"
                alt=""
              />
              <span className="flex group-hover:-top-14 ease-jump duration-200 bg-[#fc815c] sm:absolute left-1/2 sm:-translate-x-1/2 top-5 px-2 py-1 text-sm sm:text-base mt-2 rounded w-max items-center gap-1 after:hidden sm:after:block after:w-4 after:h-4 after:bg-inherit after:absolute after:left-1/2 after:-translate-x-1/2 after:rotate-45 after:-bottom-2">
                Book Vault
          ...
          <div className="w-full">
            ...
            <p className="text-justify text-sm md:text-base mt-2">
              Book Vault is your personal library in the digital world, offering
              a vast collection of books across various genres. Easily explore,
              organize, and manage your favorite reads with a user-friendly
              interface designed for book lovers. Whether you're discovering new
              titles or revisiting classics, Book Vault ensures seamless access
              to your literary treasures anytime, anywhere. Dive into a world of
              stories and knowledge with Book Vault, where your reading journey
        ...
        <div className="w-[2px] hidden sm:block bg-[#1788ae] absolute top-0 bottom-0 left-1/2 -translate-x-1/2" />
      </section>
          ...
          <div className="swiper-wrapper items-center">
              ...
              <div className="flex flex-col md:flex-row w-full md:max-w-[800px] items-center rounded-lg p-9 shadow-[0_0px_50px_rgba(59,130,246,0.6)] cursor-grab">
                ...
                <div className="testimonial-text ml-6 text-left pt-6 md:pt-16 relative">
                  <p className="text-sm md:text-base mb-2">
                    “Anurag is a talented, committed individual who will leave
                    no stone unturned in his pursuit to provide with the best.
                    His attention to detail and in-depth experience in the of
                    web development is indeed commendable. He has exhibited
            ...
            <div className="swiper-slide px-4">
              <div className="flex flex-col md:flex-row max-w-[800px] items-center rounded-lg p-9 shadow-[0_0px_50px_rgba(59,130,246,0.6)] cursor-grab">
                ...
                <div className="testimonial-text ml-6 text-left pt-6 md:pt-16 relative">
                  <p className="text-sm md:text-base mb-2">
                    “Anurag was a wonderful developer to work with! He
              ...
              <div className="flex flex-col md:flex-row max-w-[800px] items-center rounded-lg p-9 shadow-[0_0px_50px_rgba(59,130,246,0.6)] cursor-grab">
                ...
                <div className="testimonial-text ml-6 text-left pt-6 md:pt-16 relative">
                  <p className="text-sm md:text-base mb-2">
                    ...
                    looking at his work ethic and dedication. Working with him
      ...
      <section className={`max-w-screen-xl mx-auto px-4 pb-12  ${state?"text-black bg-white":"text-white bg-black"}`}>
        <h2 className={`text-3xl sm:text-[40px] ${state?"text-[#1788ae] bg-white":"text-[#1788ae] bg-[#111]"} relative z-10 font-bold px-4 py-2 w-max mx-auto text-center  sm:border-2 border-[#1788ae] rounded-md`}>
          Let's Connect
        </h2>
