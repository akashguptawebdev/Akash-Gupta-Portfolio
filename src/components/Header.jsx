...
const Header = () => {
  ...
  return (
    <header className={`bg-transparent ${state?"text-white":"text-white"} pointer-events-none flex items-center mx-auto max-w-[95vw] lg:max-w-[90vw] justify-between pt-2 px-4 z-20 relative`}>
      <Link to="">
        <svg
          className="w-12 sm:w-20 pointer-events-auto cursor-pointer"
          width="70"
          height="70"
          viewBox="0 0 406 368"
          fill="none"
      ...
      <div className={`${state?"text-white":"text-white"} gap-2 sm:gap-4 flex pointer-events-auto cursor-pointer`}>
        {state ? (
        ...
        <Link to="tel:8434381886" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
        ...
        <Link
          to="https://wa.me/8434381886?text=Hi, How are you"
          target="_blank"
        >
          <svg
            aria-hidden="true"
